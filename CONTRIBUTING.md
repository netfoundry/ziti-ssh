...
- Ensure your commit messages in Git include `fix netfoundry/ziti-ssh#<issuer-number>` as the first line of the commit message, followed by a blank line, and then whatever detail you want to provide.
- Include in the pull request the same text, `fix netfoundry/ziti-ssh#<issue-number>` either in the title or body.
